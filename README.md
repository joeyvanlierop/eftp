...
<i>X is a random available port the client has chosen, Y is a static port number the server
always listens on, and Z is a random available port the server has chosen for this session.
Port numbers are omitted in the remaining figures.</i></figcaption>
</figure>
<figure style="display: inline-table; margin-left: 0;" >
  <img src="./assets/fig-2.png" alt="Fig.2" style="height: 600px"/>
  <figcaption style="display: table-caption; caption-side: bottom;">Figure 2: Complete sequence of uploading a file to the server and save it as ”File.txt” (size: 1588 bytes) under ideal situation</figcaption>
</figure>
<figure style="display: inline-table; margin-left: 0;" >
  <img src="./assets/fig-3.png" alt="Fig.3" style="height: 600px"/>
  <figcaption style="display: table-caption; caption-side: bottom;">Figure 3: Complete sequence of uploading a file to the server and save it as ”File.txt” (size: 1588 bytes) under ideal situation but the first segment has two retransmissions</figcaption>
</figure>
<figure style="display: inline-table; margin-left: 0;" >
  <img src="./assets/fig-4.png" alt="Fig.4" style="height: 600px"/>
  <figcaption style="display: table-caption; caption-side: bottom;">Figure 4: Complete sequence of uploading a file to the server and save it as ”File.txt” (size: 3088 bytes) under possible real world situation</figcaption>
</figure>
